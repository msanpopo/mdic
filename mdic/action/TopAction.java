...
public class TopAction extends AbstractAction{
    ...
    public TopAction(Player player) {
        ...
        putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_F4, InputEvent.SHIFT_DOWN_MASK));
        //putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_HOME, 0));
        this.player = player;
    }
    
    public void actionPerformed(ActionEvent e) {
        System.out.println("TopAction.performed");
        player.top();
    }
}